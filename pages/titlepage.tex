...
\begin{titlepage}
  \begin{center}
    ...
    {%
      \vspace*{.27cm}
      \Huge{\RCAW}\\[1.23ex]
      \Large Entry-Level Competition\\[2ex]
      Rulebook \\[2ex]
    }
...
\begin{verbatim}
	@misc{at_work_entry_level_rulebook_2025,
		author = {Asad Norouzi, Christoph Steup},
		title  = {RoboCup@Work 2025 - Entry-Level Rulebook},
		year   =  2025,
